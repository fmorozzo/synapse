                    ...
                    <div class=" bg-white rounded flex items-center w-full p-3 shadow-sm border border-gray-200">
                      ...
                      <div class="select">
                        <select name="" id="" x-model="image_type" class="text-sm outline-none focus:outline-none bg-transparent">
                          ...
                          <option value="photo">Artists</option>
                          <option value="illustration">Titles</option>
                          <option value="vector">Label</option>
                         </select>
                      </div>
                    </div>
...
export default {
  components: { RecordsList },
    ...
    methods: {
        ...
        key: function(event) {
            this.formula = 'filterByFormula=SEARCH(LOWER(%22' + this.query + '%22)%2C+LOWER(Artist))',
