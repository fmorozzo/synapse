...
<template>
                ...
                <div class="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                  ...
                  <div class="mt-6 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                    <div class="sm:hidden 2xl:block mt-6 min-w-0 flex-1">
                      ...
                      <h4 class="text-lg font-bold text-gray-600"> {{ record.trackNumber }} - {{ record.song }}</h4>
                    </div>
                    <!--
              ...
              <div class="border-b border-gray-200">
                <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                  <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    ...
                    -->
                    <a v-for="tab in tabs" :key="tab.name" :href="tab.href" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                      {{ tab.name }}
                      </a>
                  </nav>
                </div>
 ...
 <div class="bg-white border-b overflow-hidden">
    <ul class="divide-y divide-gray-200">
      <li v-for="track in record.tracks" :key="track.title">
        <a href="#" class="block hover:bg-gray-50">
          <div class="px-4 py-4 flex items-center sm:px-6">
            <div class="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
              <div class="truncate">
                <div class="flex text-sm">
                  <p class="font-medium text-gray-600 truncate">{{ track.trackNumber }} - {{ track.title }}</p>
                </div>
                <div class="mt-2 flex">
              ...
              <div class="mt-4 flex-shrink-0 sm:mt-0 sm:ml-5">
                <div class="flex overflow-hidden -space-x-1">
                  <img v-for="applicant in track.applicants" :key="applicant.email" class="inline-block h-6 w-6 rounded-full ring-2 ring-white" :src="applicant.imageUrl" :alt="applicant.name" />
                </div>
              </div>
            </div>
...
import { ChevronLeftIcon,ChevronRightIcon, FilterIcon, MailIcon, PhoneIcon, SearchIcon } from '@heroicons/vue/solid'

const tabs = [
  { name: 'Tracks', href: '#', current: true },
  { name: 'Related Charts', href: '#', current: false },
  { name: 'Related Syners', href: '#', current: false },
]
const record = {
  id: '678',
  artist: 'D.Y.A',
